...
const PlaceOrder = () => {
    ...
    const { navigate, backendUrl, token, cartItems, setCartItems, getCartAmount, delivery_fee, products } = useContext(StoreContext);
        ...
        try {
            ...
            switch (method) {
                ...
                case 'razorpay':
                    ...
                    const responseRazorpay = await axios.post(backendUrl + '/api/v1/order/razorpay', orderData, {headers:{token}})
